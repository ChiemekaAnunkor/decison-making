...
if (temperature > 80 && rain) {
  ...
  console.log("ne should wear a jacket and carry an umbrella");
} else {
  console.log(" one should wear layers ");
}
...
for (let i = 0; i < passingScore; i++) {
  console.log(i + "you score isnt high enough");
}
